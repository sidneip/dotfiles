...
map("n", "<leader>v", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, {desc = "Add harpoon"})
...
map("n", "<leader>lQ", "<cmd> lua vim.diagnostic.setqflist({workspace: true}) <CR>", {desc = "Quickfix error of workspace"})
...
map('n', '<leader>gcp', '<cmd>lua require"gitsigns".prev_hunk()<CR>', {desc = 'Last modification', noremap = true, silent = true})
map('n', '<leader>gcn', '<cmd>lua require"gitsigns".next_hunk()<CR>', {desc = 'Next modification', noremap = true, silent = true})
-- blame
map('n', '<leader>gb', '<cmd>lua require"gitsigns".blame_line(true)<CR>', {desc = 'Blame', noremap = true, silent = true})
